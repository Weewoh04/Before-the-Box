...
export const categories = [
  { icon: '🧈', title: 'Kitchen Staples', description: 'Butter, yogurt, broth, mayo, sour cream, and everyday basics.' },
  { icon: '🍞', title: 'Baking Basics', description: 'Bread, tortillas, biscuits, crackers, pizza dough, and mixes.' },
  { icon: '🥫', title: 'Pantry Swaps', description: 'Seasonings, sauces, dressings, creamers, and packet replacements.' },
  { icon: '🍓', title: 'Kids Snacks', description: 'Fruit leather, granola bars, gummies, popsicles, and lunchbox swaps.' },
  { icon: '🧼', title: 'Home + Cleaning', description: 'Laundry powder, sprays, dish tabs, and practical household recipes.' },
  { icon: '💄', title: 'Beauty + Body', description: 'Lip balm, tallow balm, sugar scrubs, dry shampoo, and body care.' }
];
